...
export const CuisineForm = ({ initialData }: CuisineFormProps) => {
    ...
    const description = initialData ? "Edit your Cuisine" : "Create a new Cuisine";
    const toastMessage = initialData ? "Cuisine updated successfully" : "Cuisine created successfully";
